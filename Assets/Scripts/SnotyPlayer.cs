...
public class SnotyPlayer : Player
{

    private SoundsNames gumExplosion = SoundsNames.SnotExplosion;
    private SoundsNames blowinGumUP = SoundsNames.SnotUp;
    private SoundsNames blowinGumDown = SoundsNames.SnotDown;
